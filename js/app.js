    ...
    //FourSquare API Request | declare reference properties
        ...
        self.sortedLocations().forEach(function(req) {
            ...
            success: function(response) {
                ...
                infoWindow.setContent(resp.name + '<br>' + req.phone + '<br>' + resp.location.address + '<br>' + resp.location.city + ', ' + resp.location.state + ' ' + resp.location.postalCode + '<br>'  + '<a href="' + req.website + '">' + req.website + '</a>' + '<br>' + '<a href="' + req.twitterLink + '">' + '@' + req.twitter + '</a>');
